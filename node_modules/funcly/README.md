...
* toCelsius(*degrees|number*, *startingUnit|string* ``(available starting units are: kelvin, celsius and fahrenheit)``) - Converts the **degrees** argument from the **startingUnit** argument to Celsius.
* toFahrenheit(*degrees|number*, *startingUnit|string* ``(available starting units are: kelvin, celsius and fahrenheit)``) - Converts the **degrees** argument from the **startingUnit** argument to Fahrenheit.
* toKelvin(*degrees|number*, *startingUnit|string* ``(available starting units are: kelvin, celsius and fahrenheit)``) - Converts the **degrees** argument from the **startingUnit** argument to Kelvin.
